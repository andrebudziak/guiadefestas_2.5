                               ...
                               <asp:GridView ID="grdBonus" runat="server" 
                                   ...
                                   <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Status">
                                          <ItemTemplate>
                                                <asp:DropDownList ID="ddlStatus" Enabled="false" runat="server" SelectedValue='<%# Eval("codigo_status")%>'>
    ...
    style="width: 50px; height: 50px" />Aguarde..
               ...
               <tr>
                   <td>
                       &nbsp;</td>
                   <td>
                             <asp:GridView ID="grdRelBonus" runat="server" 
                                   AutoGenerateColumns="False" CellPadding="4" DataSourceID="ObjectDataSource1" 
                                   Font-Names="Arial" Font-Size="11px" ForeColor="#333333" GridLines="Horizontal" 
                                   ShowFooter="True" 
                                   AllowPaging="False">
                                   ...
                                   <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Anunciante">
                                           <ItemTemplate>
                                              <asp:Label ID="lblAnunciante" runat="server" Text='<%# Bind("anunciante") %>' Width="200px" />
                                           </ItemTemplate>
                                       </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Status">
                                          <ItemTemplate>
