<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadastro_categoria_banner.aspx.cs" Inherits="cadastro_categoria_banner" %>
                       ...
                       <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                           <ContentTemplate>
                               ...
                               <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                   ...
                                   onselecting="ObjectDataSource1_Selecting" SelectMethod="DadosBannerCategoria" 
                                   TypeName="WebService" UpdateMethod="IncluirBannerCategoria" 
                                   ondeleting="ObjectDataSource1_Deleting" 
                                   oninserting="ObjectDataSource1_Inserting" 
                                   onupdating="ObjectDataSource1_Updating">
                                   <DeleteParameters>
                                       <asp:Parameter Name="codigo_banner" Type="Int32" />
                               ...
                               <asp:GridView ID="grdCategoriaBanner" runat="server" AllowPaging="True" 
                                   ...
                                   onrowcommand="grdCategoriaBanner_RowCommand" 
                                   onrowcreated="grdCategoriaBanner_RowCreated" ShowFooter="True" 
                                   onrowdeleting="grdCategoriaBanner_RowDeleting">
